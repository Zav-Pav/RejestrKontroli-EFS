...
using RejestrKontroli.DAL;
using RejestrKontroli.Models;

namespace RejestrKontroli.Controllers
{
    public class RejestrModelsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            RejestrModel rejestrModel = db.Rejestr.Find(id);
        ...
        {
            RejestrModel rejestrModel = db.Rejestr.Find(id);
            db.Rejestr.Remove(rejestrModel);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
